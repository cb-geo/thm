...
// // Temperature seetings for extraction
// const int g_num_T_bnd_id = 10;
// const int g_T_bnd_id[g_num_T_bnd_id] = {23, 3, 1, 2, 4, 5, 7, 8, 11311,
// 11312};

// Temperature seetings for injection
const int g_num_T_bnd_id = 3;
const int g_T_bnd_id[g_num_T_bnd_id] = {23, 3, 6};
...
// // Heat flow rate settins for extraction
...
const int g_QT_bnd_id[g_num_QT_bnd_id] = {0};  // velocity  boundary
const double g_QT_well = 0;                    // wellbore temperature
